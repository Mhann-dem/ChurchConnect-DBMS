...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'churchconnect'),
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@churchconnect.com')
...
CHURCH_NAME = os.environ.get('CHURCH_NAME', 'Your Church Name')
CHURCH_ADDRESS = os.environ.get('CHURCH_ADDRESS', '')
CHURCH_PHONE = os.environ.get('CHURCH_PHONE', '')
CHURCH_EMAIL = os.environ.get('CHURCH_EMAIL', '')
